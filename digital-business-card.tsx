  ...
  return (
    <>
      ...
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-100 to-slate-200 p-2 sm:p-4 dark:from-gray-900 dark:to-slate-900 transition-colors duration-300">
        <div
          className={`relative w-full max-w-[320px] sm:max-w-md transition-all duration-700 ${flipped ? "rotate-y-180" : ""}`}
              ...
              <div className="flex flex-col items-center space-y-2.5 sm:space-y-4">
                ...
                <div className="w-full border-t dark:border-gray-700 pt-2 sm:pt-3">
                  <Tabs defaultValue="about" className="w-full" onValueChange={setActiveTab}>
                    ...
                    <TabsContent
                      value="about"
                      className="mt-2 sm:mt-3 text-[10px] sm:text-xs dark:text-gray-200 max-h-[150px] overflow-y-auto pr-1"
                    >
                      ...
                      <div className="flex w-full justify-center pt-2 sm:pt-3">
                        <Button
                          ...
                          className="text-[10px] sm:text-xs h-6 sm:h-7 px-2 sm:px-3 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700 hover:bg-slate-100 transition-colors"
                        >
                          More Info
                        </Button>
                      </div>
                    ...
                    <TabsContent
                      value="experience"
                      className="mt-2 sm:mt-3 text-[10px] sm:text-xs max-h-[150px] overflow-y-auto pr-1"
                    >
                      <div>
                        ...
                        <p className="text-[9px] sm:text-xs text-muted-foreground dark:text-gray-400">
                          June 2023 – Present
                        </p>
                        <ul className="mt-1.5 sm:mt-2 list-inside list-disc text-[10px] sm:text-xs dark:text-gray-200 space-y-1">
                    ...
                    <TabsContent value="skills" className="mt-2 sm:mt-3 max-h-[150px] overflow-y-auto pr-1">
                      <div className="flex flex-wrap gap-1 sm:gap-1.5">
                        <Badge
                          variant="secondary"
                          className="text-[9px] sm:text-xs py-0.5 h-5 dark:bg-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors"
                        >
                          IFRS
                        </Badge>
                        <Badge
          ...
          >
            <CardContent className="p-2.5 sm:p-6 overflow-y-auto max-h-[100vh]">
              <div className="flex flex-col space-y-2.5 sm:space-y-4">
                ...
                <ul className="list-inside list-disc space-y-1 text-[9px] sm:text-xs dark:text-gray-200">
                  <li>
                ...
                <div className="flex flex-wrap gap-1 sm:gap-1.5">
                  <Badge className="text-[9px] sm:text-xs py-0.5 h-5 dark:bg-blue-600 dark:hover:bg-blue-700 transition-colors">
                    Financial Services
                  </Badge>
                  <Badge className="text-[9px] sm:text-xs py-0.5 h-5 dark:bg-blue-600 dark:hover:bg-blue-700 transition-colors">
                ...
                <div className="bg-slate-50 dark:bg-gray-700/50 rounded-lg p-2 sm:p-3 border border-slate-200 dark:border-gray-700 mb-1 sm:mb-2">
                  <div className="flex flex-col text-[9px] sm:text-xs">
